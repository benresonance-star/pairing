...
'GDLG' 32700 Palette | topCaption | close | grow 40 0 760 760 "BuildSync Wrapper Manager" {
 Button             675  728   70   24     LargePlain  "Close"
 SingleSelList       12   32  280  250     SmallPlain  NoPartialItems  16
 LeftText            12   10  120   18     SmallPlain  vCenter  "Wrappers"
 Button              12  292  132   24     LargePlain  "Create from Selection"
 Button             152  292   95   24     LargePlain  "Delete"
 Button              12  322  132   24     LargePlain  "Select Members"
 Button             152  322  132   24     LargePlain  "Add Selection"
 Button              12  352  132   24     LargePlain  "Remove Selection"
 Button             152  352  132   24     LargePlain  "Repair Registry"
 LeftText           304   10  140   18     SmallPlain  vCenter  "Wrapper Details"
 LeftText           304   42   75   18     SmallPlain  vCenter  "ID"
 TextEdit           385   40  300   22     SmallPlain  255
 LeftText           304   72   75   18     SmallPlain  vCenter  "Name"
 TextEdit           385   70  300   22     SmallPlain  255
 LeftText           304  102   75   18     SmallPlain  vCenter  "Type"
 TextEdit           385  100  300   22     SmallPlain  255
 LeftText           304  132   75   18     SmallPlain  vCenter  "Zone"
 TextEdit           385  130  300   22     SmallPlain  255
 LeftText           304  162   75   18     SmallPlain  vCenter  "Level"
 TextEdit           385  160  300   22     SmallPlain  255
 LeftText           304  192   75   18     SmallPlain  vCenter  "Trade"
 TextEdit           385  190  300   22     SmallPlain  255
 LeftText           304  222   75   18     SmallPlain  vCenter  "Task ID"
 TextEdit           385  220  300   22     SmallPlain  255
 LeftText           304  252   75   18     SmallPlain  vCenter  "Status"
 TextEdit           385  250  300   22     SmallPlain  255
 Button             385  282  110   24     LargePlain  "Save Details"
 LeftText           304  322   75   18     SmallPlain  vCenter  "Prop Key"
 TextEdit           385  320  160   22     SmallPlain  255
 LeftText           304  352   75   18     SmallPlain  vCenter  "Prop Value"
 TextEdit           385  350  300   22     SmallPlain  255
 Button             555  320   60   24     LargePlain  "Set"
 Button             622  320   80   24     LargePlain  "Remove"
 LeftText            12  398  650   24     SmallPlain  vCenter  ""
 Button              12  382   85   24     LargePlain  "Refresh"
 Button             638  758    1    1     LargePlain  ""
 LeftText            12  440   80   18     SmallPlain  vCenter  "Members"
 Button             100  436  125   24     LargePlain  "Show Members"
 SingleSelList       12  588  728  132     SmallPlain  NoPartialItems  16  HasHeader  18
 LeftText            12  468  100   18     SmallPlain  vCenter  "Sub-Wrappers"
 SingleSelList       12  492  500   72     SmallPlain  NoPartialItems  16
 Button             525  492  110   24     LargePlain  "Add Selected"
 Button             642  492  110   24     LargePlain  "Remove Child"
 Button             525  522  140   24     LargePlain  "Select Branch"
 Button             304  382  118   24     LargePlain  "Place Instance"
 Button             430  382  108   24     LargePlain  "Select Inst."
 Button             546  382   96   24     LargePlain  "Enter Edit"
 Button             304  412  118   24     LargePlain  "Apply Edit"
 Button             430  412  108   24     LargePlain  "Cancel Edit"
}
